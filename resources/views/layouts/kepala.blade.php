        ...
        <aside :class="darkMode ? 'bg-slate-950 border-slate-800 text-slate-300' : 'bg-slate-950 border-gray-200 text-slate-300'"
            ...
            <div>
                ...
                <nav class="px-4 py-6 space-y-1">
                    ...
                    <button @click="setTab('overview')"
                            :class="activeTab === 'overview' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                    ...
                    <button @click="setTab('approval')"
                            :class="activeTab === 'approval' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm transition-all duration-150 cursor-pointer relative">
                        <span>⏳</span> <span>Menunggu Approval</span>
                        {{-- Dot merah notifikasi total pending approval --}}
                        <span id="pending-badge-total" class="absolute right-3 top-3 w-2 h-2 bg-red-500 rounded-full hidden"></span>
                    </button>

                    <button @click="setTab('kirim')"
                            :class="activeTab === 'kirim' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm transition-all duration-150 cursor-pointer">
                        <span>📢</span> <span>Kirim Catatan</span>
                    </button>

                    <button @click="setTab('riwayat')"
                            :class="activeTab === 'riwayat' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm transition-all duration-150 cursor-pointer">
                        <span>📋</span> <span>Riwayat Catatan</span>
                    </button>
                    ...
                    <button @click="setTab('prod_sembako')"
                            :class="activeTab === 'prod_sembako' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                    ...
                    <button @click="setTab('prod_logistik')"
                            :class="activeTab === 'prod_logistik' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2 rounded-xl text-xs transition-all duration-150 cursor-pointer pl-6">
                        <span>📦</span> <span class="truncate">Pengadaan & Logistik</span>
                    </button>

                    <button @click="setTab('prod_agrobisnis')"
                            :class="activeTab === 'prod_agrobisnis' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2 rounded-xl text-xs transition-all duration-150 cursor-pointer pl-6">
                    ...
                    <button @click="setTab('lay_simpanpinjam')"
                            :class="activeTab === 'lay_simpanpinjam' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2 rounded-xl text-xs transition-all duration-150 cursor-pointer pl-6">
                        <span>💰</span> <span class="truncate">Simpan Pinjam</span>
                    </button>

                    <button @click="setTab('lay_kemitraan')"
                            :class="activeTab === 'lay_kemitraan' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2 rounded-xl text-xs transition-all duration-150 cursor-pointer pl-6">
                        <span>🤝</span> <span class="truncate">Kemitraan Usaha</span>
                    </button>

                    <button @click="setTab('lay_konsultasi')"
                            :class="activeTab === 'lay_konsultasi' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2 rounded-xl text-xs transition-all duration-150 cursor-pointer pl-6">
                        <span>💼</span> <span class="truncate">Konsultasi Keuangan</span>
                    </button>

                    <button @click="setTab('lay_pelayanan')"
                            :class="activeTab === 'lay_pelayanan' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2 rounded-xl text-xs transition-all duration-150 cursor-pointer pl-6">
                        <span>👥</span> <span class="truncate">Pelayanan Anggota</span>
                    </button>

                    <button @click="setTab('lay_pemasaran')"
                            :class="activeTab === 'lay_pemasaran' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2 rounded-xl text-xs transition-all duration-150 cursor-pointer pl-6">
                        <span>📣</span> <span class="truncate">Pemasaran Produk</span>
                    </button>

                    <button @click="setTab('lay_pelatihan')"
                            :class="activeTab === 'lay_pelatihan' ? 'bg-blue-600 text-white font-extrabold shadow-md' : 'text-slate-400 hover:bg-slate-900 hover:text-white'"
                            class="w-full text-left flex items-center gap-3 px-4 py-2 rounded-xl text-xs transition-all duration-150 cursor-pointer pl-6">
            ...
            <div class="p-4 border-t border-slate-800">
                <div class="flex items-center gap-3 px-2">
                    <div class="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center text-sm font-bold text-white flex-shrink-0">K</div>
                    <div class="min-w-0">
        ...
        <main class="flex-1 flex flex-col min-w-0 min-h-screen">
            ...
            <header :class="darkMode ? 'bg-slate-950 border-slate-800' : 'bg-white border-gray-200'"
                ...
                <div class="flex items-center gap-2 text-sm">
                    <span class="text-gray-400 font-medium">Kepala Panel</span>
