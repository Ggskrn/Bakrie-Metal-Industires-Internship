    ...
    <div class="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-bakrie-dark to-slate-900 px-8 py-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="font-heading font-bold text-white text-lg leading-tight">KOP AJS</p>
                    <p class="text-[10px] text-gray-300 font-semibold tracking-wider">ANDAL · JAYA · SEJAHTERA</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="mt-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required autofocus
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-bakrie-gold focus:ring focus:ring-bakrie-gold/20 transition">
                    @error('email')
                ...
                <button type="submit" class="w-full bg-bakrie-gold text-bakrie-dark font-bold py-3 rounded-xl hover:bg-amber-400 transition shadow-lg">
                    Masuk
                </button>
            </form>
            ...
            <a href="{{ route('google.redirect') }}" class="flex items-center justify-center gap-3 w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl transition shadow-sm">
